...
input_field = Entry(input_frame, font=('arial', 18, 'bold'), textvariable=input_text, width=50, bg='powderblue', bd=0,
                    justify=RIGHT)
...
buton_clear = Button(frame_butoane, text='C', width=33, height=3, bg='#eee', cursor='hand2',
